<template>
    <div v-if="!open" class="fixed lg:max-w-[35%] lg:max-h-[80%] lg:m-auto flex flex-col inset-0 z-10 bg-grey lg:rounded-xl">
        ...
        <div class="flex flex-col h-full px-3 pb-8 lg:p-10 max-lg:pt-16">
            ...
            <div @click="deleteCat()" class="mt-7 lg:mt-16 p-2 lg:py-5 text-center lg:text-3xl text-grey  rounded-lg bg-white cursor-pointer border-white border-[4px] transition-all duration-100 hover:bg-grey hover:text-white">
                Удалить
            </div>
        </div>
    </div>
